    ...
    <div class="col-md-4 offset-md-4">
                    ...
                    <div class="container">
                        ...
                        <form id="checkout-form">
                            ...
                            <div class="form-actions">
                                ...
                                <button type="submit" class="btn btn-primary" onclick="">Confirmar Pedido</button>
                            </div>
                        </form>
                    </div>
                </section>
            ...
            <div class="qr-modal-content">
                ...
                <div id="qr-code-container" class="qr-code-container">
                    <img id="qr-code-image" src="qr.png" alt="QR Code PIX" style="display: block; max-width: 200px;">
                </div>

                <div class="pix-copy-paste">
                    <label for="pix-code">PIX Copia e Cola:</label>
                    <div class="input-with-button">
                        <input type="text" id="pix-code" value="00020126360014br.gov.bcb.pix0114+55519815802055204000053039865802BR5912Luiz P Moura6012Porto Alegre62290525TT8Py5lEGebYsSxFVqXGu4CSv63042A55" readonly>
                ...
                <div class="payment-instructions">
                    ...
                    <ol>
                        ...
                        <li>Use a opção "PIX Copia e Cola" e cole o código acima, ou escaneie o QR Code</li>
                ...
                <div class="modal-actions">
                    ...
                    <button type="button" class="btn btn-primary" onclick="closePixModal()">Verificar Pagamento</button>
                </div>
            </div>
        </div>
            <!-- Modal Recibo -->
            ...
            function copyPixCode() {
                ...
                try {
                    // Tenta usar a API de área de transferência moderna
